...
const { rows: existing } = await pool.query('SELECT * FROM customers WHERE phone = $1', [phone]);  
    ...
    await pool.query('INSERT INTO customers (customer_name, phone, email, loyalty_points) VALUES ($1, $2, $3, $4)', [name, phone, email || null, loyalty_points || 0]);  
...
await pool.query('UPDATE customers SET customer_name = $1, phone = $2, email = $3, loyalty_points = $4 WHERE id = $5',  
